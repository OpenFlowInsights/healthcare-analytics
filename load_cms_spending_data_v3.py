...
def main():
    ...
    for dataset in DATASETS:
        ...
        # 3. Create table using INFER_SCHEMA with stage and REPLACE_INVALID_CHARACTERS
        create_table_sql = f"""
        ...
        # 4. Copy data into table with PARSE_HEADER
        copy_sql = f"""
